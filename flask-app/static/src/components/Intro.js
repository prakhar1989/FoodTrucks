    ...
    return (
      <div className="intro">
        ...
        <p>
          ...
          <a href="http://prakhar.me/docker-curriculum">docker curriculum</a> -
          a comprehensive tutorial on getting started with Docker targeted
        ...
        <p>
          ...
          giving me the idea of using this color scheme. If you love it, I
          smugly take all the credit. ⊂(▀¯▀⊂)
        </p>
        <p>
          Lastly, the data for the food trucks is made available in public
          domain by{" "}
